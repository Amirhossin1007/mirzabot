...
function self_update_script() {
    ...
    local URL="https://raw.githubusercontent.com/Amirhossin1007/mirzabot/main/install.sh"
...
GIT_REPO="Amirhossin1007/mirzabot"
...
function migrate_to_pro() {
    ...
    rm -rf "$OLD_BOT_DIR"
    mkdir -p "$NEW_BOT_DIR"
    ZIP_URL="https://github.com/Amirhossin1007/mirzabot/archive/refs/heads/main.zip"
